...
const (
	...
	InventoryService_ScanBarcode_FullMethodName = "/inventory.InventoryService/ScanBarcode"
...
type InventoryServiceClient interface {
	...
	ScanBarcode(ctx context.Context, in *ScanBarcodeRequest, opts ...grpc.CallOption) (*Item, error)
	// Manajemen stok
...
func (c *inventoryServiceClient) ScanBarcode(ctx context.Context, in *ScanBarcodeRequest, opts ...grpc.CallOption) (*Item, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Item)
	err := c.cc.Invoke(ctx, InventoryService_ScanBarcode_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type InventoryServiceServer interface {
	...
	ScanBarcode(context.Context, *ScanBarcodeRequest) (*Item, error)
	// Manajemen stok
...
func (UnimplementedInventoryServiceServer) ScanBarcode(context.Context, *ScanBarcodeRequest) (*Item, error) {
...
func _InventoryService_ScanBarcode_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ScanBarcodeRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(InventoryServiceServer).ScanBarcode(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: InventoryService_ScanBarcode_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(InventoryServiceServer).ScanBarcode(ctx, req.(*ScanBarcodeRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var InventoryService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _InventoryService_ScanBarcode_Handler,
		},
		{
